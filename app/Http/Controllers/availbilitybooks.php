...
class availbilitybooks extends Controller
{
    ...
    public function viewbooks(Request $req){
         ...
         $sid=$req->inv;
        $sbook=availbilitybook::with('book')->where('name',$sid)->where('pharma_id','=',$pid)->orderBy('date', 'DESC')->get();
    ...
    public function addNew(Request $req){
        $pid=session('pharma_id');
         $sid=$req->pid;
        $sbook=availbilitybook::with('book')->where('name',$sid)->where('pharma_id','=',$pid)->get();
