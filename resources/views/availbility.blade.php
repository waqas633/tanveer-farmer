...
<div class="container">
    ...
    <h1 align="center"  style="margin:30px;">New Availbility Bill</h1>
    ...
    <div align="center" style="margin:20px;margin-bottom: 20px;">
     ...
     <form method="GET" action="" autocomplete="off">
        ...
        <label style="width:100px;text-align: left;">Invoice No:</label><input type="text" value="1" name="inv"  style="width: 178px;" id="inv" placeholder="Enter Invoice Number">
                <label style="width:100px;text-align: left;">Date</label><input type="text" name="date" id="date" style="width: 178px;"  value="<?php echo $date=date("Y-m-d");?>"><br>
<label style="width:100px;text-align: left;">Party Name</label><input type="text" name="partN" id="partN" style="margin-top: 3px;width: 178px;" value=""   onkeyup="sst()">
<br>
        <label style="width:100px;text-align: left;">Phone</label><input type="text" name="phone" id="phone" style="width: 178px;margin-top:3px;">
       <br>
       <label style="width:100px;text-align: left;">Address</label><input type="text" name="adress" id="adress" style="margin-top: 3px;width: 178px;">
    
    </div>
    <div class="col-md-8">
        <label>Type</label><select name="type" id="type" style="width: 150px;margin-top:3px;height:30px;"  onchange = "branding()">
          <option>Select</option>
            ...
            <label style="width:80px">Brand</label><select name="brands" id="brands" style="width: 80px;margin-top:3px;height:30px;"
            ...
            <option value="Cash Party">1x1</option><option value="Cash Party">2x2</option></select><br>
            <label style="width:80px">Thikness</label><select name="thik" id="thik" style="width: 80px;margin-top:3px;height:30px;"  onchange = "dementionz()">
            <option value="Cash Party">1</option><option value="Cash Party">2</option></select>
           
            <label style="width:80px">Waranty</label><select name="waran" id="waran" style="width: 80px;margin-top:3px;height:30px;">
    ...
    <span><input type="text" name="disc11" id="disc11" value="0" placeholder="Discount" style="width:50px;height:30px;"></span>
    <span><input type="submit" id="subs" name="subs" class="btn btn-success" value="Add Item"   onsubmit = "fetchstudent()"></span>
</span>
</div>
</div>
</form>
...
<div style="float:left;margin-left: 100px;">
    ...
    <script type="text/javascript">
        ...
        function print(){
            ...
            var url = "{{ url('availbilitybillprint1?pinv=') }}"+pinv;
...
function fetchstudent(){
            var url = "{{ url('fetch-student-availbility') }}";
...
console.log(response.stx);
        $.each(response.stx,function(key,item){
            $("#ttbody").html(""); 
     bodyData+="<tr>"
     document.getElementById("partN").value=item.availbilitybooks.name;
...
alert("out of stock");
   ...
   $("#finalBill").click(function(e){
        ...
        var inv = $("input[name=inv]").val();
         ...
         //alert(inv);
         //alert(party);
        var url = "{{ url('final-bill-avilbility') }}";
