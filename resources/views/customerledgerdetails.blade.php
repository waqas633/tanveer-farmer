...
<form      onsubmit="return false">
	Enter Name: <input type="text" id="cname" name="cname">
	Start Date: <input type="date" id="date1" name="cname"  value="2023-01-01">
...
typx="DR";
     ...
     bodyData+="<tr style='height:15px;'>"
                    bodyData+="<td>"+ids+"</td><td>"+item.date+"</td><td>"+cname+"</td><td>"+item.type+"</td><td>"+item.cr+"</td><td>"+item.dr+"</td><td>"+blncs+" "+typx+"</td>";
