...
<span  style="float:center;width: 500px;">
	...
	<h1 align="center">Add New Town</h1>
	<span  style="float:left;width: 350px; margin: 3px;">
        <span  style="float:left;">Enter Town:</span><span  style="float:right;"><div class="autocomplete"> <input type="text" name="itemName" id="itemName" placeholder="Enter Town Name"></div></span></span><br>
	<span  style="float:right;width: 350px; margin: 3px;">
        <input type="submit" name="subs" id="subs" style="float:right;margin-right:45px;width:178px;" value="Add Town"  class="btn btn-success"></span>
</span>
</span>
</form>
</div>
