...
<div style="margin-top:10px;">	
	...
	<div  style="margin-top:10px;">
    <label  style="width:120px;float:left;">Name</label><input type="text" name="payname" id="payname"></div>
	<div  style="margin-top:10px;">
    <label  style="width:120px;float:left;">Details</label><input type="text" id="paydetails" name="paydetails" value="Cash Received"></div>
	<div  style="margin-top:10px;">
