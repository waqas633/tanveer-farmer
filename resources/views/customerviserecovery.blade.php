 ...
 <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script>
        ...
        function fetchstudent(){
            ...
            var proname='';
            var url = "{{ url('date-vise-recovery') }}";
$.ajax({
    url:url,
           method:'GET',
    dataType:"json",
...
cname:cname,
    ...
    success:function(response){
        ...
        document.getElementById("ts").innerHTML = response.pros2;
        $.each(response.dated2,function(key,item){
          $("#ttbody").html("");  
     bodyData+="<tr style='height:15px;'>"
                    bodyData+="<td>"+ids+"</td><td>"+item.date+"</td><td>"+item.details+"</td><td>"+item.amount+"</td>";
