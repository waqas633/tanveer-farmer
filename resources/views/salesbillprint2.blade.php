...
<tr>
 ...
 @endif
      ...
      <span align:right>
 <p  style="margin-top:10px;font-size:14px; text-align: right;"><label>Opening Balance:</label><label id="ts"></label><label style=""> {{$obb}}</label></p>
 ...
 <p  style="margin-top:-13px;font-size:14px; text-align: right;"><label>Closing Balance:</label><label id="ts">{{$obb-$price+$dix}}</label></p>
